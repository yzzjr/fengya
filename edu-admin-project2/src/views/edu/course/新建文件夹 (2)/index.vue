<template>
    <div class="app-container">
      ...
      <el-form :inline="true" class="demo-form-inline">
        <el-form-item>
          <el-input v-model="searchObj.title" placeholder="图书名"/>
        </el-form-item>


        <el-form-item>
            <el-input v-model="searchObj.subjectId" placeholder="坐标id"/>
        </el-form-item>
      ...
      <el-table
        ...
        <el-table-column prop="title" label="图书名称" width="280" />
        ...
        <el-table-column prop="status" label="图书状态" width="300">
          <template slot-scope="scope">
            <el-tag :type="scope.row.status === 'Draft'? 'primary': 'success'">{{scope.row.status==='Draft'?'未上架':'已上架'}}</el-tag>
